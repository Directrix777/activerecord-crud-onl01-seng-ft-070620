...
def can_find_using_where_clause_and_be_sorted
  ...
  Movie.connection.execute("SELECT * FROM movies WHERE release_date > 2002 ORDER BY release_date DESC").collect{|attribute_hash| Movie.find_or_create_by(attribute_hash)}
end
